#   ATIVIDADE DELETE NO BANCO DE MECÂNICA 7
#Turma: 3º Período ADS 2022/02
#Discente: Wasgton Gomes Pereira

create database bd_mecanica_7_WASGTON;
use bd_mecanica_7_WASGTON;
...
/*Hora de Praticar 1
Utilize o banco de dados da Mecânica disponibilizado na última aula e faça os exercícios a usando o
BETWEEN e LIKE:*/

#1. Selecione os clientes com renda entre 500 e 20000 e nascidos em ‘1987’ e que possui RG com
#emissão ‘sesdec’.

select * from cliente where((renda_familiar_cli between (500)and(20000))and (data_nascimento_cli between ("1987-01-01")and("1987-12-31"))and (rg_cli like "%sesdec%" )) ;

#2. Selecione os clientes com sobrenome ‘Pereira’ ou ‘Souza’ e que possuam telefone com o DDD
#’69’ e a renda entre 100 e 2000 ou 5000 e 10000;
...
#3. Selecione os clientes nascidos entre ‘1960’ e ‘1990’ e com renda entre 1000 e 10000 e com
#nome iniciado com a letra ‘J’ ou ‘M’;
...
#6. Selecione os produtos com o ‘LD’ na descrição e com quantidade entre 1 e 100 e valor entre
#500 e 5000;

select * from produto where ((descricao_prod like "%LD%")and (quant_prod between (1)and(100))and(valor_prod between (500)and(5000)));

#7. Selecione os produtos com o ‘LE’ na descrição e com ‘2020’ ou ‘2011 na descrição e com
#estoque entre 100 e 200 e valor entre 1 e 1000 e do tipo ‘Metal’ ou ‘Vidro’;


select * from produto where ((descricao_prod like "%LE%")and((descricao_prod like "%2020%") OR (descricao_prod like "%2021%")) 
and(quant_prod between (100)and(200))and(valor_prod between (1)and(1000))and((tipo_prod = "Metal")or (tipo_prod = "Vidro")));

#8. Selecione serviços do tipo ‘Conserto’ e com tempo entre 0 e 1h e valor entre 0
#e 1000;

select * from servico where ((tipo_serv = "Conserto")and(tempo_serv between ("00:00:00")and("01:00:00"))and(valor_serv between (0)and (1000)));
...
#13. Selecione endereços que com o numero entre 100 e 10000 e do bairro ‘Centro’
#e contenham um ‘.’ no nome da rua;

select * FROM endereco where ((numero_end between (100)and(10000))and(bairro_end = "Centro")and(rua_end like "%.%"));

#14. Selecione os clientes que possui rg com o termo ‘ssp’ e telefone com o ddd
#‘69’;

select * from cliente where ((rg_cli like "%ssp")and(telefone_cli like "69 %"));

#15. Agora para cada SELECT que você criou, crie um DELETE para o mesmo fim, ou
#seja, ao invés de selecionar você deverá deletar (obs: alguns registros não
#serem excluídos devido a dependência, normal);

#1. 

delete from cliente where((renda_familiar_cli between (500)and(20000))and (data_nascimento_cli between ("1987-01-01")and("1987-12-31"))and (rg_cli like "%sesdec%" )) ;
...
delete from produto where ((descricao_prod like "%LE%")and((descricao_prod like "%2020%") OR (descricao_prod like "%2021%")) 
and(quant_prod between (100)and(200))and(valor_prod between (1)and(1000))and((tipo_prod = "Metal")or (tipo_prod = "Vidro")));

#8.

delete from servico where ((tipo_serv = "Conserto")and(tempo_serv between ("00:00:00")and("01:00:00"))and(valor_serv between (0)and (1000)));
